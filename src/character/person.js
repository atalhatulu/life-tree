import {createPreferenceProfile} from '../social/preference_profile.js';
...
export function createPersonBase({id,name,surname,sex,age,rng}){
 ...
 const person={id,name,surname,sex,age,alive:true,
 ...
 person.preferencesProfile=createPreferenceProfile(person,rng.fork('preferences'));
 return person;
}
